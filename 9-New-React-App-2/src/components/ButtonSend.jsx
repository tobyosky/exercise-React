export default function ButtonSend({ sendMessage }) {
  return (
    <button
      type="button"
      onClick={sendMessage}
      className="inline-flex item-center justify-center bg-green-600 hover:cursor-pointer hover:bg-green-700 p-3 rounded-full"
    >
      <svg
        fill="#ffffff"
        viewBox="0 0 512 512"
